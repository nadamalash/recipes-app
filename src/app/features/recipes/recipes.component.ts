...
export class RecipesComponent {
  ...
  constructor(private router: Router) {
    ...
    this.isIngredsShow = false;
  }

  scrollToIngredsSection(isIngredsShow: boolean) {
    this.isIngredsShow = isIngredsShow;
    if (this.isIngredsShow) {
      this.router.navigate([], { fragment: 'ingredientSec' });
    } else {
      this.router.navigate([], { fragment: 'cardDetails' });
    }
  }
}
